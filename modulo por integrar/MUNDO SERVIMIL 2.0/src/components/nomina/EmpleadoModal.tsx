...
import type { Empleado } from "@/lib/types/nomina";
  ...
  async function guardar() {
    ...
    try {
      ...
      if (mode === "crear") {
        ...
        const res = await fetch("/api/data?ns=gestion&action=empleado-crear", {
        ...
        const res = await fetch("/api/data?ns=gestion&action=empleado-actualizar", {
          method: "POST", headers: { "Content-Type": "application/json" },
