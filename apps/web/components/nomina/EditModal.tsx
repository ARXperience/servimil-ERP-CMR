...
import type { NominaFila, Novedad } from "@/lib/nomina-module/types/nomina";
import type { NominaParametros } from "@/lib/nomina-module/parametros";
import { formatCop, toNumber, labelCorte } from "@/lib/nomina-module/utils/format";
  ...
  async function guardar() {
    ...
    try {
      ...
      if (variable) {
        ...
        const res = await fetch("/api/nomina-data?ns=nomina&action=update", {
        ...
        const res = await fetch("/api/nomina-data?ns=nomina&action=update-recalc", {
          method: "POST", headers: { "Content-Type": "application/json" },
